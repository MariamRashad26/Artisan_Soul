      ...
      <header className="d-flex align-items-center justify-content-between px-6 py-4 bg-white/80 backdrop-blur-xl sticky-top top-0 z-50 border-bottom border-gray-100">
        ...
        <div className="d-flex align-items-center gap-4">
          <div className="d-flex flex-column text-end d-none d-sm-block">
            ...
            <p className="fs-6 fw-black text-dark font-serif mb-0">${totalPrice.toFixed(2)}</p>
          </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { name: 'French Pebble Grain', priceLabel: '+$80', price: 80, color: '#1A1A1A' },
                      { name: 'Horween Shell Cordovan', priceLabel: '+$320', price: 320, color: '#3D0C02' }
                    ].map((item, i) => (
                      <button 
                         key={i} 
              ...
              <section className="animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { name: 'Vibram Commando', detail: 'All-weather traction', priceLabel: '+$45', price: 45 },
                    { name: 'Crepe Rubber', detail: 'Casual comfort', priceLabel: '+$35', price: 35 }
                  ].map((item, i) => (
                    <button 
                      key={i} 
            ...
            {activeTab === 'Details' && (
              <section className="animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100 mb-6">
                  <label className="text-[10px] text-secondary opacity-60 fw-black text-uppercase tracking-widest mb-2 d-block">Monogram Embossing (+$25)</label>
