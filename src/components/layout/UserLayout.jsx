      ...
      <aside className="w-80 flex-shrink-0 bg-dark d-none d-md-flex flex-column h-vh shadow-2xl z-50 position-relative">
        ...
        <div className="p-6 mt-auto border-top border-white/10 bg-black/20 backdrop-blur-sm">
          <div className="p-4 rounded-3xl border border-white/10 bg-white/5 d-flex align-items-center justify-content-between group hover:bg-white/10 transition duration-500 cursor-pointer">
            <div className="d-flex align-items-center gap-4">
              <div className="size-11 rounded-2xl bg-stone-800 overflow-hidden border-2 border-primary/50 shadow-sm">
                <img alt="User profile" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBGQW95aVrs9P0CFTsaVaep4wChUJ_LO9ocTQkS2QQg6voZHCCsNpgUxop7lKdT0XIJ9CfW3Op72gjilvoX1K7GvCFf05BdebZmzOOMGe66ZWKoWOQHsooTWF7VnqlHUPRfTCA_yUy4AMcTYYMFOIufxSrLxbnuU5FpzR-SqhozTl6Sks4H9zNRrctVvbkCrJC1SaaYg6gOCG9R3jSRLWFcnOFvELBLwlQpBwRqc9hwcHm2aBPI0PnUxEtVywtmzYIfOccPgSMos3xc" className="w-100 h-100 object-cover" />
              </div>
              <div className="d-flex flex-column">
                <span className="text-xs fw-black text-white tracking-tight">{user?.name || 'Julian Sterling'}</span>
                <span className="text-[9px] fw-black text-uppercase tracking-widest text-primary">Elite Collector</span>
              </div>
            </div>
